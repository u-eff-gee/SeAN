...
_DEPS = Experiment.h Config.h CrossSection.h Target.h Absorption.h Settings.h InputReader.h Plotter.h Writer.h
DEPS = $(patsubst %,$(INCDIR)/%,$(_DEPS))

_OBJ = Experiment.o main.o CrossSection.o Target.o Absorption.o Settings.o InputReader.o Plotter.o Writer.o
